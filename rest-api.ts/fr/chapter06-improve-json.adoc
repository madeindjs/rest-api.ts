...
Dans ce chapitre, nous allons personnaliser la sortie JSON en utilisant la gemme https://github.com/SeyZ/jsonapi-serializer[jsonapi-serializer] qui respecte toutes les normes https://jsonapi.org/[JSON:API].
