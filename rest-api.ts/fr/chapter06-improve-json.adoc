...
const userSerializerOptions: SerializerOptions = {
  attributes: ["email"],
  dataLinks: {
...
export const userSerializer = new Serializer("users", userSerializerOptions);
----
