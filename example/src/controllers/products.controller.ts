...
import { controller, httpDelete, httpGet, httpPost, httpPut, requestBody } from "inversify-express-utils";
...
export class ProductController {
  ...
  public async create(@requestBody() body: Partial<Product>, req: Request & { user: User }, res: Response) {
    const repository = await this.databaseService.getRepository(ProductRepository);
