...
Un grand merci à https://github.com/madeindjs/rest-api.ts/graphs/contributors[tous les contributeurs de API on Rails], à tous ceux qui ont supporté le projet en https://leanpub.com/rest-api-ts[achetant une version payante de ce livre] et aux https://github.com/madeindjs/rest-api.ts/graphs/contributors[tous les contributeurs de API on Rails].
